...
from Dataloader.Dataloader_FS6 import FS6_dataset
import cv2 as cv
...
def main():
    ...
    pth_path_root = "../Train_S/Record/Defocus/model_best.pth"
    save_root = "Record/Defocus/"
    # pth_path_root = "../Train_S/Record/FlyingThings3D/model_best.pth"
    # save_root = "Record/FlyingThings3D_Defocus/"
