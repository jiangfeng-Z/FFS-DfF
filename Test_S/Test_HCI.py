...
from Ablation.Dataloader_A.Dataloader_HCI import HCI_dataset
import cv2 as cv
...
def main():
    ...
    pth_path_root = "../Train_S/Record/HCI_20/model_best.pth"
    save_root = "Record/HCI_20/"


    data_root = "/mnt/data2/zhangjiangfeng/zjf_data/PublicDataset/4D-Light-Field-Dataset/HCI_FS_trainval_20.h5"
