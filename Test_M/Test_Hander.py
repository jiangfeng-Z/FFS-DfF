...
def main(interval):
    ...
    pth_path_root = "../Train_M/Record/Hander_S/model_best.pth"
    save_root = "Record/Hander_S/" + str(interval) + "/"
    ...
    with torch.no_grad():
        ...
        for idx, samples in enumerate(tqdm(dataloader, desc="Test")):
            ...
            color_img = cmap(adjust(pred, 0, 1))[:, :, 0:3]
            ...
            color_img_gt = cmap(adjust(test_gt_depth, 0, 1))[:, :, 0:3]
