...
def main():
    ...
    parser.add_argument('--record_root', default="Record/HCI_10_S/", type=str,
                        help='save root')
    parser.add_argument('--data_root',
                        default="/mnt/data2/zhangjiangfeng/zjf_data/PublicDataset/4D-Light-Field-Dataset/HCI_FS_trainval_10.h5",
                        type=str,
                        help='data root')
